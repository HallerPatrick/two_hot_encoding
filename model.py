...
class TransformerModel(nn.Module):
    ...
    def __init__(self, dictionary, ninp, nhead, nhid, nlayers, dropout=0.5):
        ...
        self.encoder = NGramsEmbedding(self.ntoken, ninp)
        self.ninp = ninp
    ...
    def forward2(self, input, ordered_sequence_lengths=None):
        ...
        encoded = self.encoder(input) * math.sqrt(self.ninp)
